...
CREATE TABLE `projeto` (
  ...
  KEY `FK_PROJETO_COLABORADOR_idx` (`colaborador`),
  CONSTRAINT `FK_PROJETO_COLABORADOR` FOREIGN KEY (`colaborador`) REFERENCES `colaborador` (`cod_col`) ON DELETE NO ACTION ON UPDATE NO ACTION
